...
export default function PaymentPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* demo banner removed for presentation */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-lg font-bold text-gray-900">MediaPay</h1>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mt-6 bg-gray-100 border border-gray-200 rounded-lg p-4">
              ...
              <p className="text-sm text-gray-600">
                ...
                <a href="mailto:support@mediapay.com" className="text-primary hover:underline">
                  support@mediapay.com
                </a>
              </p>
            </div>
          </div>
